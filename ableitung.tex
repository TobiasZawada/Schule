...
Polynome ersten Grades, d.h., mit $n=1$ kennst du sicher, das sind linearen Funktionen mit Konstantanteil $p_0$ und Anstieg $p_1$.

Auch quadratische Polynome, d.h., mit $n=2$ habt ihr sicher schon in der Schule gehabt.
...
\begin{align*}
  ...
  \ddx f(x) &= n x^{n-1}
\end{align*}
Definieren wir $x^0=1$ (auch für den Fall $x=0$), so passt auch der Fall der linearen Funktion~\eqref{eq:limit:ddxp1}
...
\begin{align*}
  \frac{\Delta y}{\Delta x} &= \frac{f(x+\Delta x) - f(x)}{\Delta x}\\
                            &= \frac{\alpha g(x+\Delta x) + \beta h(x+\Delta x) - (\alpha g(x) + \beta h(x))}{\Delta x}\\
                            &= \alpha \frac{g(x+\Delta x) - g(x)}{\Delta x} + \beta \frac{h(x+\Delta x)- h(x)}{\Delta x}\\
                            &= \alpha\frac{\Delta}{\Delta x} g(x) + \beta\frac{\Delta}{\Delta x} h(x)
\end{align*}
\begin{align*}
  \ddx{}(\alpha g(x) + \beta h(x)) &= \alpha \ddx g(x) + \beta\ddx h(x)
\end{align*}
